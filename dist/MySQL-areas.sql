...
CREATE TABLE `area` ( 
    ...
    `provinceCode` varchar(10)  DEFAULT NULL COMMENT "省份编码", 
     ...
     KEY `index_cityCode` (`cityCode`) USING BTREE,  
     KEY `index_all` (`provinceCode`,`cityCode`) USING BTREE  
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4  COMMENT="行政区"; 
INSERT INTO `area`(`code`, `name`, `cityCode`, `provinceCode`) VALUES 
 ("110101","东城区","1101","11"),
("110102","西城区","1101","11"),
("110105","朝阳区","1101","11"),
("110106","丰台区","1101","11"),
